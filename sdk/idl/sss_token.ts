  ...
  instructions: [
    {
      ...
      accounts: [
        ...
        { name: "stablecoin_config"; writable: true },
      ];
      args: [];
    },
    {
      ...
      accounts: [
        ...
        { name: "role_manager"; writable: true },
      ];
      args: [
        { name: "minter"; type: "pubkey" },
        { name: "quota"; type: "u64" },
      ];
    },
    {
      ...
      accounts: [
        ...
        { name: "stablecoin_config" },
        { name: "role_manager" },
        { name: "blacklist_entry"; writable: true },
        { name: "system_program" },
      ];
      args: [
    ...
    },
    {
      ...
      args: [
        { name: "role"; type: { defined: { name: "RoleType" } } },
    ...
    },
    {
      ...
      accounts: [
        ...
        { name: "stablecoin_config" },
        { name: "mint" },
        { name: "extra_account_meta_list"; writable: true },
        { name: "hook_program" },
        { name: "system_program" },
      ];
      args: [];
    },
    {
      ...
      args: [
        ...
        { name: "enable_permanent_delegate"; type: "bool" },
        { name: "enable_transfer_hook"; type: "bool" },
        { name: "default_account_frozen"; type: "bool" },
      ];
    },
    {
      name: "mint_tokens";
